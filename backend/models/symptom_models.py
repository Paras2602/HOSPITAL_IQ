...
class DiagnosisSession(Base):
    ...
    final_diagnosis: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    model_version: Mapped[str | None] = mapped_column(String(20), nullable=True, default="v2.0")
